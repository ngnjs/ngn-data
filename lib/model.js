 ...
 */
class Entity extends NGN.Class {
  constructor (config) {
    config = config || {}
    super(config)
    ...
    Object.defineProperties(this, {
       ...
       * be unique.
       */
      autoid: NGN.define(true, true, false, NGN.coalesce(config.autoid, false)),
